...
SELECT nama_usaha , skala_usaha, tahun_berdiri FROM view_umkm_detail;

DROP DATABASE dbhotel2

SELECT * FROM umkm

SELECT tanggal_registrasi, deskripsi_usaha, omzet_per_tahun, total_aset, jumlah_karyawan, tahun_berdiri, npwp, nib, alamat_usaha, id_kabupaten_kota,
id_skala, id_kategori, id_pemilik FROM umkm WHERE  tanggal_registrasi < '2021-01-01' OR tanggal_registrasi > '2021-12-30' ;

SELECT tanggal_registrasi, deskripsi_usaha, omzet_per_tahun, total_aset, jumlah_karyawan, tahun_berdiri, npwp, nib, alamat_usaha, id_kabupaten_kota,
id_skala, id_kategori, id_pemilik FROM umkm WHERE tanggal_registrasi >= '2021-01-01' AND tanggal_registrasi <= '2021-12-31';
